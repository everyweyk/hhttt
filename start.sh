...
# configs
AUUID=621263ad-937e-41f0-85ac-c7816d7e880f
CADDYIndexPage=https://github.com/PavelDoGreat/WebGL-Fluid-Simulation/archive/master.zip
CONFIGCADDY=https://raw.githubusercontent.com/fdfb5654/hhttt/master/etc/Caddyfile
CONFIGXRAY=https://raw.githubusercontent.com/fdfb5654/hhttt/master/etc/xray.json
